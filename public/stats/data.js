...
let beers=[
  ...
  {beer:"Harp Lager",                           style:"Lager",          origin:"IE",    abv:4.5,method:"Draft", city:"Montreal",       region:"Quebec",              country:"Canada",     cc:"CA",rating:3.00,isNew:false,month:"Jan",monthN:1,year:2026},
  ...
  {beer:"Negra Modelo",                         style:"Lager",          origin:"MX",    abv:5.4,method:"Bottle",city:"New Rochelle",   region:"New York",            country:"USA",        cc:"US",rating:3.50,isNew:false,month:"Feb",monthN:2,year:2026},
  ...
  {beer:"Żywiec",                               style:"Lager",          origin:"PL",    abv:5.5,method:"Bottle",city:"New Rochelle",   region:"New York",            country:"USA",        cc:"US",rating:2.00,isNew:true, month:"Mar",monthN:3,year:2026},
  ...
  {beer:"Stiegl Goldbräu",                      style:"Lager",          origin:"AT",    abv:5.0,method:"Bottle",city:"New Rochelle",   region:"New York",            country:"USA",        cc:"US",rating:2.50,isNew:true, month:"Mar",monthN:3,year:2026},
  ...
  {beer:"Dos Equis Lager Especial",             style:"Lager",          origin:"MX",    abv:4.2,method:"Draft", city:"Queens",         region:"New York",            country:"USA",        cc:"US",rating:1.00,isNew:true, month:"Apr",monthN:4,year:2026},
  ...
  {beer:"Medalla Light",                        style:"Lager",          origin:"PR",    abv:4.2,method:"Bottle",city:"San Juan",       region:"Puerto Rico",         country:"USA",        cc:"US",rating:4.00,isNew:true, month:"Jun",monthN:6,year:2026},
  {beer:"Magna",                                style:"Lager",          origin:"PR",    abv:4.5,method:"Bottle",city:"San Juan",       region:"Puerto Rico",         country:"USA",        cc:"US",rating:4.00,isNew:true, month:"Jun",monthN:6,year:2026},
  {beer:"Ocean SJU",                            style:"Lager",          origin:"PR",    abv:5.9,method:"Bottle",city:"San Juan",       region:"Puerto Rico",         country:"USA",        cc:"US",rating:2.50,isNew:true, month:"Jun",monthN:6,year:2026},
  {beer:"Bloodline Blood Orange IPA",           style:"IPA",            origin:"US",    abv:8.0,method:"Bottle",city:"San Juan",       region:"Puerto Rico",         country:"USA",        cc:"US",rating:2.50,isNew:true, month:"Jun",monthN:6,year:2026},
  ...
  // JUL 2026 (5 reviews)
  {beer:"Stone IPA",                            style:"IPA",            origin:"US",    abv:6.9,method:"Can",   city:"New Rochelle",   region:"New York",            country:"USA",        cc:"US",rating:2.25,isNew:true, month:"Jul",monthN:7,year:2026},
...
let drunkLocs=[
  ...
  {city:"San Juan",       region:"Puerto Rico",         country:"USA",        cc:"US",lat:18.4655,lng:-66.1057},
...
let breweries=[
  ...
  {name:"Harp / Diageo",                     location:"Dundalk, County Louth",                   country:"Ireland",           cc:"IE",    lang:"en",beers:"Harp Lager",                                                                               lat:54.0039,lng:-6.3703,  ratings:[3.00]},
  ...
  {name:"Żywiec Brewery (Grupa Żywiec)",     location:"Żywiec, Silesia",                         country:"Poland",            cc:"PL",    lang:"pl",beers:"Żywiec",                                                                                   lat:49.6853,lng:19.1925,  ratings:[2.00]},
  ...
  {name:"Stieglbrauerei zu Salzburg",        location:"Salzburg, Land Salzburg",                 country:"Austria",           cc:"AT",    lang:"de",beers:"Stiegl Goldbräu",                                                                          lat:47.8095,lng:13.0550,  ratings:[2.50]},
  ...
  {name:"Cervecería Cuauhtémoc Moctezuma",   location:"Monterrey, Nuevo León",                   country:"Mexico",            cc:"MX",    lang:"es",beers:"Dos Equis Lager Especial",                                                                 lat:25.6866,lng:-100.3161,ratings:[1.00]},
  ...
  {name:"Stone Brewing",                     location:"Escondido, California",                   country:"USA",               cc:"US",    lang:"en",beers:"Stone IPA",                                                                                lat:33.1192,lng:-117.0864,ratings:[2.25]},
...
"Efes Pilsener":"efespilsen.com.tr",
"Cass Fresh":"cass.co.kr",
"Steinlager Classic":"steinlager.com",
"Lapin Kulta":"lapinkulta.fi",
"Karlovačko":"karlovacko.hr",
"Saku Originaal":"saku.ee",
"Obolon Premium Extra Brew":"obolon.ua",
"Zagorka":"zagorka.bg",
"Cristal":"cristal.com.pe",
"Club Colombia Dorada":"clubcolombia.com.co",
"Nikšićko Pivo":"niksickopivo.com",
"Ciuc Premium":"ciuc.ro",
...
"Hitachino Nest White Ale":"logos/hitachino-nest-white-ale.webp",
...
"Lapin Kulta":"logos/lapin-kulta.webp",
"Laško Zlatorog":"logos/lasko-zlatorog.webp",
...
"Nikšićko Pivo":"logos/niksicko-pivo.webp",
...
"Saku Originaal":"logos/saku-originaal.webp",
...
"Steinlager Classic":"logos/steinlager-classic.webp",
...
const WANT_TO_TRY=[
  ...
  {beer:"Efes Pilsener",        style:"Pilsner",    origin:"TR",    abv:5.0,region:"Istanbul, Marmara",          untappd:3.05,method:"Bottle"},
  {beer:"Cass Fresh",           style:"Lager",      origin:"KR",    abv:4.5,region:"Icheon, Gyeonggi",           untappd:2.78,method:"Can"   },
  {beer:"Steinlager Classic",   style:"Lager",      origin:"NZ",    abv:5.0,region:"Auckland",                   untappd:3.15,method:"Bottle"},
  {beer:"Lapin Kulta",          style:"Lager",      origin:"FI",    abv:4.5,region:"Lahti, Päijät-Häme",         untappd:3.00,method:"Can"   },
  {beer:"Karlovačko",           style:"Lager",      origin:"HR",    abv:5.4,region:"Karlovac, Karlovac County",  untappd:3.05,method:"Bottle"},
  {beer:"Saku Originaal",       style:"Lager",      origin:"EE",    abv:4.7,region:"Saku, Harju County",         untappd:3.05,method:"Bottle"},
  {beer:"Obolon Premium Extra Brew",style:"Lager",      origin:"UA",    abv:4.6,region:"Kyiv",                       untappd:3.10,method:"Bottle"},
  {beer:"Zagorka",              style:"Lager",      origin:"BG",    abv:5.0,region:"Stara Zagora",               untappd:3.00,method:"Bottle"},
  {beer:"Cristal",              style:"Lager",      origin:"PE",    abv:5.0,region:"Lima",                       untappd:2.95,method:"Bottle"},
  {beer:"Club Colombia Dorada", style:"Lager",      origin:"CO",    abv:4.7,region:"Bogotá, Cundinamarca",       untappd:3.30,method:"Bottle"},
  {beer:"Nikšićko Pivo",        style:"Lager",      origin:"ME",    abv:5.0,region:"Nikšić",                     untappd:3.10,method:"Bottle"},
  {beer:"Ciuc Premium",         style:"Lager",      origin:"RO",    abv:5.0,region:"Miercurea Ciuc, Harghita",   untappd:2.90,method:"Can"   },
  {beer:"Laško Zlatorog",       style:"Lager",      origin:"SI",    abv:4.9,region:"Laško, Savinja",             untappd:3.10,method:"Bottle"},
];
