...
insert into public.locations (city,region,country,cc,lat,lng) values
  ...
  ('San Juan','Puerto Rico','USA','US',18.4655,-66.1057),
...
insert into public.breweries (name,location,country,cc,lang,native_name,lat,lng) values
  ...
  ('Badische Staatsbrauerei Rothaus','Grafenhausen, Baden-Württemberg','Germany','DE','de',null,47.8333,8.2167)
...
update public.beers b
  ...
  (58,'Medalla Light','Compañía Cervecera de Puerto Rico','Lager','PR',4.2,'Bottle','San Juan','Puerto Rico','USA','US',4,true,'2026-06-01',null),
  (59,'Magna','Compañía Cervecera de Puerto Rico','Lager','PR',4.5,'Bottle','San Juan','Puerto Rico','USA','US',4,true,'2026-06-01',null),
  (60,'Ocean SJU','Ocean Lab Brewing Co.','Lager','PR',5.9,'Bottle','San Juan','Puerto Rico','USA','US',2.5,true,'2026-06-01',null),
  (61,'Bloodline Blood Orange IPA','Flying Dog Brewery','IPA','US',8,'Bottle','San Juan','Puerto Rico','USA','US',3.5,true,'2026-06-01',null),
  ...
  (80,'Amstel Light','Amstel Brouwerij (Heineken)','Lager','NL',3.5,'Bottle','Tarrytown','New York','USA','US',2.5,true,'2026-09-01',null),
  (81,'Rothaus Pils / Tannen Zäpfle','Badische Staatsbrauerei Rothaus','Pilsner','DE',5.1,'Draft','New York','New York','USA','US',2.75,true,'2026-09-01',null)
...
insert into public.brand_domains (beer_name,domains,logo) values
  ('Affligem Tripel'::text,array['affligembeer.com','affligembeer.be']::text[],'logos/affligem-tripel.svg'::text),
  ('Almaza Pilsener',array['almaza.com.lb'],'logos/almaza-pilsener.webp'),
  ...
  ('Estrella Jalisco',array['estrellajalisco.com'],'logos/estrella-jalisco.svg'),
  ...
  ('Guinness Draught',array['guinness.com'],'logos/guinness-draught.svg'),
  ...
  ('Mahou Cinco Estrellas',array['mahou.com','mahou.es'],'logos/mahou-cinco-estrellas.webp'),
  ...
  ('Mythos',array['mythosbeer.gr'],'logos/mythos.webp'),
  ('Hofbräu Dunkel',array['hofbraeu-muenchen.de'],'logos/hofbrau-dunkel.svg'),
  ('Hop Commander',array['captainlawrencebrewing.com'],'logos/hop-commander.svg'),
  ...
  ('Pilsner Urquell',array['pilsnerurquell.com','prazdroj.cz'],'logos/pilsner-urquell.webp'),
  ...
  ('Sol',array['cervezasol.com','solbeer.com'],'logos/sol.svg'),
  ...
  ('Stiegl Goldbräu',array['stiegl.at'],'logos/stiegl-goldbrau.svg'),
