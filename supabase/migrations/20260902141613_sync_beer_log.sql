...
insert into public.brand_domains (beer_name,domains,logo) values
  ('Affligem Tripel'::text,array['affligembeer.be']::text[],'logos/affligem-tripel.webp'::text),
  ('Almaza Pilsener',array['almaza.com'],'logos/almaza-pilsener.webp'),
  ...
  ('Ichnusa Anima Sarda',array['ichnusa.com'],'logos/ichnusa-anima-sarda.webp'),
  ...
  ('De Koninck',array['dekoninck.be'],'logos/de-koninck.webp'),
  ...
  ('Duvel',array['duvel.com'],'logos/duvel.webp'),
  ('Erdinger Weißbier',array['erdinger.de'],'logos/erdinger-weissbier.svg'),
  ('Estrella Damm',array['estrelladamm.com'],'logos/estrella-damm.webp'),
  ...
  ('Heineken',array['heineken.com'],'logos/heineken.webp'),
  ('Heineken Silver',array['heinekensilver.com','heineken.com'],'logos/heineken-silver.webp'),
  ...
  ('Kirin Ichiban',array['kirin.co.jp'],'logos/kirin-ichiban.webp'),
  ('Kronenbourg 1664',array['1664.com','kronenbourg1664.com'],'logos/kronenbourg-1664.webp'),
  ...
  ('Mahou Cinco Estrellas',array['mahou.es'],'logos/mahou-cinco-estrellas.webp'),
  ...
  ('Mythos',array['mythosbrewery.gr'],'logos/mythos.webp'),
  ('Hofbräu Dunkel',array['hofbraeu-muenchen.de'],'logos/hofbrau-dunkel.webp'),
  ('Hop Commander',array['captainlawrencebrewing.com'],'logos/hop-commander.webp'),
  ('Hofbräu Münchner Weiße',array['hofbraeu-muenchen.de'],'logos/hofbrau-munchner-weisse.webp'),
  ...
  ('Newcastle Brown Ale',array['newcastlebrown.com','newcastlebrownale.com'],'logos/newcastle-brown-ale.webp'),
  ('Norrlands Guld',array['norrlandsguld.se'],'logos/norrlands-guld.webp'),
  ...
  ('Belhaven Scottish Stout',array['belhaven.co.uk'],'logos/belhaven-scottish-stout.webp'),
  ('Singha',array['singhabeer.com'],'logos/singha.webp'),
  ('Smithwick''s',array['smithwicks.com','smithwicks.ie'],'logos/smithwicks.webp'),
  ('Sol',array['solbeer.com','cervezasol.com'],'logos/sol.webp'),
  ...
  ('Tennent''s',array['tennents.com','tennents.co.uk'],'logos/tennents.webp'),
  ('Texels Skuumkoppe',array['texels.nl'],'logos/texels-skuumkoppe.webp'),
  ('Tiger Beer',array['tigerbeer.com'],'logos/tiger-beer.svg'),
  ('Tsingtao',array['tsingtaobeer.com'],'logos/tsingtao.webp'),
  ('Tuborg',array['tuborg.com'],'logos/tuborg.webp'),
  ('Tyskie',array['tyskie.pl'],'logos/tyskie.webp'),
  ('Victoria Bitter',array['vb.com.au','victoriabitter.com.au'],'logos/victoria-bitter.webp'),
